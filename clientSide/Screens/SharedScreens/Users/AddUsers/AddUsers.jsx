...
const AddUsers = () => {
  ...
  const [studentId, setStudentId] = useState('8888')
  const [firstName, setFirstName] = useState('Arava');
  const [lastName, setLastName] = useState('Tsoury');
  const [password, setPassword] = useState('8888');
  const [phone, setPhone] = useState('1471471477');
  const [email, setEmail] = useState('araTz@gmail.com');
